  ...
  const instagramPosts = [
    {
      ...
      caption: "Descobrindo paraísos escondidos no Brasil! 🏝️ #Viagem #Brasil #Paraíso",
      likes: 342,
      comments: 28,
      time: "2 horas"
    },
    {
      ...
      caption: "Paris sempre rouba nosso coração! 🗼❤️ #Paris #França #TorreEiffel",
      likes: 567,
      comments: 41,
      time: "5 horas"
    },
    {
      ...
      caption: "Aventuras incríveis te aguardam! 🎒✈️ #Aventura #Viagem #Mochileiro",
      likes: 289,
      comments: 19,
      time: "8 horas"
    },
    {
      ...
      caption: "Por do sol perfeito nas Maldivas 🌅 #Maldivas #PorDoSol #Paraíso",
      likes: 721,
      comments: 62,
      time: "1 dia"
    },
    {
      ...
      caption: "Natureza exuberante e pontes de tirar o fôlego! 🌿🌊 #Natureza #Cachoeira #Aventura",
      likes: 445,
      comments: 33,
      time: "2 dias"
    },
    {
      ...
      caption: "Explorando culturas fascinantes pelo mundo! 🌍🎭 #Cultura #Viagem #Descoberta",
      likes: 398,
      comments: 25,
      time: "3 dias"
    }
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-6">
              🌍 Agência de Turismo | ✈️ Realizando sonhos pelo mundo | 📸 Compartilhando aventuras incríveis
            </p>
            
            <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
              <div className="text-center">
                <div className="font-bold text-xl text-gray-800">{instagramPosts.length}</div>
                <div>publicações</div>
              </div>
              <div className="text-center">
          ...
          <div className="text-center mt-12 p-8 bg-white/70 backdrop-blur-sm rounded-3xl border border-white/30">
            ...
            <p className="text-gray-600 mb-6">Não perca nenhuma aventura e inspire-se com destinos incríveis</p>
            <a
