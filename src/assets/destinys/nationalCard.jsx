...
const NationalCard = ({ isAdmin = false }) => {
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      const storage = getStorage();
      const storageRef = ref(storage, `nationalOffers/${Date.now()}_${file.name}`);
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-600 font-medium">Carregando ofertas nacionais...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="text-center py-12">
        <div className="flex flex-col items-center space-y-4">
          ...
          <h3 className="text-xl font-semibold text-gray-700">Nenhuma oferta nacional encontrada</h3>
          <p className="text-gray-500">Em breve teremos novos destinos nacionais disponíveis!</p>
        </div>
      </div>
    );
  }
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-xs text-gray-500 mb-1">Pacotes a partir de</span>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Alterar Imagem</label>
                <input
                  type="file"
                  accept="image/*"
